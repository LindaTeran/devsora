...
<form action="<?php echo JRoute::_($this->request_url); ?>" method="post" name="adminForm" id="adminForm"
	...
	<fieldset class="adminform">
		...
		<table style="display: none;" cellspacing="3" cellpadding="0" border="0" width="100%">
			<tr>
				<td align="right"><input type="button" class="button btn btn-default" name="back"
		...
		<div class="action-bill">
			<input type="button" class="button btn btn-default" name="back" value="<?php echo JText::_('COM_REDSHOP_CANCEL'); ?>" onclick="javascript:cancelForm(this.form);">
			<input type="submit" class="button btn btn-primary" name="submitbtn" value="<?php echo JText::_('COM_REDSHOP_SAVE'); ?>">
		</div>
	</fieldset>
